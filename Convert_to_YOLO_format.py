...
Data_Folder = os.path.join(get_parent_dir(1), "Object_Detection_Yolo", "model_data")
VoTT_Folder = os.path.join(Data_Folder, "vott-csv-export")
VoTT_csv = os.path.join(VoTT_Folder, "labell-export.csv")
YOLO_filename = os.path.join(Data_Folder, "data_train.txt")

# model_folder = os.path.join(Data_Folder, "Model_Weights")
classes_filename = os.path.join(Data_Folder, "data_classes.txt")
